...
View.Formula.prototype = {
	...
	registerEvents: function() {
		...
		this.button.click(function(e) {
			View.Formula.Editor.open(self.item);
			return false;
		});
	},
	...
	registerOnSubmit: function() {
		...
		this.chooser.find('.submit').click(function() {
			...
			if (!s)
				...
				View.Item.addItem(self.obj, s, self.chooser);
			}
			return false;
		});
	},
 ...
 */
View.IncomeStatement = function(target, options) {
	this.opt = {
		id: null,
		type: null,
		onItemClick: null,
...
View.IncomeStatement.prototype = {
	...
	initialize: function() {
		...
		this.target.find('.add-account').click(function() {
			var chooser = new View.Item.Chooser(self.target, {
